...
public class OutputView {
    ...
    public static void calendarHoliday30Message(int month, int numDay, String day, String staffName) {
        if (month == 6 && numDay == 6) {
    ...
    public static void calendarHoliday31Message(int month, int numDay, String day, String staffName) {
        if (month == 1 && numDay == 1) {
            System.out.printf("%d월 %d일 %s(휴일) %s\n", month, numDay, day, staffName);
            return;
        }
